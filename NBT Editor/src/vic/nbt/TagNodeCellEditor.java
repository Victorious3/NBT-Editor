...
public class TagNodeCellEditor extends DefaultTreeCellEditor
{
	...
	public boolean isCellEditable(EventObject event) 
    {
		...
		if(tree.getLastSelectedPathComponent() != null && tree.getLastSelectedPathComponent() instanceof TagLeaf)
		{
			...
			if(cell.getParent() != null && cell.getParent() instanceof ListTagNode) return false;
		}
		return true;
    }
	...
	{
		if(name.length() == 0) throw new IllegalArgumentException("Length of name can't be 0!");

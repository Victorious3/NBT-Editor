...
public class TagNodeRenderer extends DefaultTreeCellRenderer
{
	...
	public Component getTreeCellRendererComponent(JTree tree, Object value, boolean sel, boolean expanded, boolean leaf, int row, boolean hasFocus) 
	{
		...
		{
		case NBTConstants.TYPE_BYTE: setIcon(iconByte); break;
		case NBTConstants.TYPE_SHORT: setIcon(iconShort); break;
		case NBTConstants.TYPE_INT: setIcon(iconInt); break;
		case NBTConstants.TYPE_LONG: setIcon(iconLong); break;
		case NBTConstants.TYPE_FLOAT: setIcon(iconFloat); break;
		case NBTConstants.TYPE_DOUBLE: setIcon(iconDouble); break;
		case NBTConstants.TYPE_BYTE_ARRAY: setIcon(iconByteArray); break;
		case NBTConstants.TYPE_INT_ARRAY: setIcon(iconIntArray); break;
		case NBTConstants.TYPE_STRING: setIcon(iconString); break;
		case NBTConstants.TYPE_LIST: setIcon(iconList); break;
		case NBTConstants.TYPE_COMPOUND: setIcon(iconCompound); break;
		}
